...
1、优化了页面加载和逻辑处理的关系，进行功能分离

2、重构加载配置函数

### V0.62

1、修复了替换路径下没有权限删除球馆文件的bug
2、修复了打开选择替换mods路径后，显示相同选项的情况
3、修复了点开配置后，主页面按钮丢失颜色的问题
4、优化了快捷键重复注册、频繁创建Toplevel窗口导致的内存泄露问题
5、篮球和球衣界面增加提示"暂未实装"
6、重新选择levels路径后会自动同步开关键的状态
7、设置增加恢复默认快捷键功能
8、替换了程序icon
9、新增debug_utils.py，用于管控调试日志
10、设置选项增加了debug调试功能，用于收集用户遇到的问题

### V0.61

1、重构开关选择路径逻辑，重命名按钮（避免误会）

2、修复前面选择完路径后不会切换开关的问题

3、同步更新config.json文件（遗漏问题）

### V0.6

1、解决设置完快捷键会注册两次回调的问题

2、处理了两处不合适的前台调用

3、重构了UI框架，分为三个标签（篮球、球场、球衣）
